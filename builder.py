...
class Builder:
    ...
    # v7.2.5: a caixa cinza do cabeçalho fica SÓ em "NN. (BANCA / Órgão / Ano)".
    # Qualquer texto após o ")" (comando, enunciado) desce para o corpo, sem
    # caixa, independentemente do que a IA mandar no campo cabecalho.
    @staticmethod

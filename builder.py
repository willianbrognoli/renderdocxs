...
class Builder:
    ...
    def subtitle(self, titulo):
        ...
        self.add(p)
        # respiro também com keepNext para a corrente alcançar o conteúdo
        self.add('<w:p><w:pPr><w:keepNext/></w:pPr></w:p>')
    ...
    def questao(self, cabecalho, corpo, certo_errado=False):
        ...
        for linha in corpo:
            self.add(retext_para(self.f.q_corpo, linha, highlight_fgv=False))

...
- v6.1: cópias embutidas têm o fsType normalizado para Editable (8). Fontes com licença Preview&Print (caso da Winner Sans) eram recusadas pelo LibreOffice na carga do embed.

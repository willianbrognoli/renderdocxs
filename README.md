...
- v7: revisão totalmente centralizada (itens, temas e a tabela interna com respiro igual nas laterais), setas em preto, título sempre "O QUE ESTUDEI" (forçado pelo builder) e sem highlight amarelo de banca nas seções de questões.
